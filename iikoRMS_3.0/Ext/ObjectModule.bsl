...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	//
	ПараметрыРегистрации.Вставить("Наименование", "Загрузка из iikoRMS 6.2.4");
	...
	//
	ПараметрыРегистрации.Вставить("Информация", "Загрузка из iikoRMS 6.2.4");
	...
	//
	ДобавитьКоманду(ТаблицаКоманд, "Загрузка из iikoRMS 6.2.4", Команда, "ОткрытиеФормы", Истина);
