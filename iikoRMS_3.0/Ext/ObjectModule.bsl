...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	//
	ПараметрыРегистрации.Вставить("Наименование", "Загрузка из iikoRMS 6.2.2");
	...
	//
	ПараметрыРегистрации.Вставить("Информация", "Загрузка из iikoRMS 6.2.2");
	...
	//
	ДобавитьКоманду(ТаблицаКоманд, "Загрузка из iikoRMS 6.2.2", Команда, "ОткрытиеФормы", Истина);
