...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	//
	ПараметрыРегистрации.Вставить("Наименование", "Загрузка из iikoRMS 6.2.3");
	...
	//
	ПараметрыРегистрации.Вставить("Информация", "Загрузка из iikoRMS 6.2.3");
	...
	//
	ДобавитьКоманду(ТаблицаКоманд, "Загрузка из iikoRMS 6.2.3", Команда, "ОткрытиеФормы", Истина);
